...
XXX > Figure out best (basic) display of media items, eg. embedded cards TUMBLES
XXX> Pull trip feeds into user feeds based on following (with refresh link if anything is AJAX'd)... or AJAX the feed in the first place?  Hmm.
