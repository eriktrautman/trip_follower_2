...
User pages:
> Finish landing page benefit boxes
> case insensitivity to usernames uniqueness
...
> Couldn't render when not using AJAX for my tripadmins destroy render edit_trip_path(params[:trip_id])
> Working with data- attributes
> Double firing the radio buttons!
> Not disabled public view!
> passing urls to JS using content-tags?
