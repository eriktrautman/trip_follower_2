...
*************************
PRESSING:
>>> Trip subscriptions -- create the controller and the routes to let people subscribe to trips and show all their trip subscriptions
>>> Make the subscribe/unsubscribe buttons reflect this
> did the ubsubscribe model method where work? if so refactor the admin one
...
> I can view all my subscribed trips
>> Pass in button classes to the following forms
