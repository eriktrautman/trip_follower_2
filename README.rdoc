...
> Set up the javascript modifiers for each div to work with the scrolling
> Make the snap-to work
> fix the divs in the prev and next positions properly until their turn
> resize and fade the divs properly until it's their turn
