...
> Make the snap-to work
> Clean up the code for efficiency and smoothness
> properly arc their path to the main content box
> set up the navigation seeds
> set up the meta trip content hoverbox
